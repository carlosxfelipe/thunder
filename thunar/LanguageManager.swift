...
enum Translations {
    static func getText(_ key: String, for lang: AppLanguage) -> String {
        let dict: [String: [AppLanguage: String]] = [
            ...
            "sort_folders_first": [.ptBR: "Ordenar pastas primeiro", .en: "Sort folders first"],
            ...
            "make_executable": [.ptBR: "Tornar Executável", .en: "Make Executable"],
            "remove_executable": [.ptBR: "Remover Permissão de Execução", .en: "Remove Executable Permission"],
            "run_script": [.ptBR: "Executar Script no Terminal", .en: "Run Script in Terminal"],
            ...
            "apply_to_all": [.ptBR: "Aplicar a Tudo", .en: "Apply to All"],
        ...
        let spanish: [String: String] = [
            ...
            "sort_folders_first": "Ordenar carpetas primero",
            ...
            "make_executable": "Hacer Ejecutable",
            "remove_executable": "Quitar Permiso de Ejecución",
            "run_script": "Ejecutar Script en Terminal",
            "cancel": "Cancelar",
            "delete": "Eliminar",
